...
#pragma mark 读取缓存数据
-(id)readCache{
    return [JYCache getCacheResponseDataForUrl:_apiDetails.api parameters:_apiDetails.parameters userKey:JYUserKey];;
}
#pragma mark 缓存数据
-(void)wirteCacheWithResponse:(id)response{
    [JYCache cacheResponseData:response Url:_apiDetails.api parameters:_apiDetails.parameters userKey:JYUserKey];
}
